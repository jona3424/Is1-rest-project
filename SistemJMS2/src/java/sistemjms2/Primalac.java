...
import static sistemjms2.Main.connectionFactory;
import static sistemjms2.Main.qodgovora;
import static sistemjms2.Main.qpodsistem1;
        ...
        while (true) {
            try {
                ...
                if (responseCode/100 <=2){
                    ...
                    TextMessage msg=context.createTextMessage("Doslo je do greske");
                    jMSProducer.send(qodgovora, msg);
                }
