...
import static sistemjms3.Main.connectionFactory;
import static sistemjms3.Main.qodgovora;
import static sistemjms3.Main.qpodsistem;
...
public class Primalac extends Thread {
    ...
    public void run() {
        ...
        JMSConsumer consumer = context.createConsumer(qpodsistem,"Tip=1");
